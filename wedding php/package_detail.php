...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
                ...
                <div class="float-left bg-white">
                    <h5 class="h5 text-uppercase mb-5 pt-3 pl-3 pr-3">
                        ...
                        <span class="float-right text-capitalize">Price: $
                            <?= number_format($category->price, 2); ?></span>
                    </h5>
            ...
            <form action="<?php echo $_SERVER['PHP_SELF'] . '?id=' . $_GET['id']; ?>" method="post" style="background: white;padding: 20px;">
                    <?php
                    if ($session->message()) {
                    ...
                    <div class="form-row">
                        <div class="input-group col-md-12">
                            <input type="text" class="form-control" name="wedding_date" data-provide="datepicker"
                                id="wedding_date" placeholder="Wedding Date">
